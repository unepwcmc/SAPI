...
GROUP BY taxon_concepts.id, taxon_concepts.legacy_id,
  geo_entities.id, geo_entity_types.name, geo_entities.name_en,
  geo_entities.iso_code2, "references".citation, "references".id,
