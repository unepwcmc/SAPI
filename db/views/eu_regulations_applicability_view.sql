DROP VIEW IF EXISTS eu_regulations_applicability_view;
...
CASE WHEN inner_i.effective_at = outer_i.effective_at THEN inner_i.end_date ELSE inner_i.effective_at END
...
SELECT intervals.start_date::DATE, intervals.end_date::DATE, ARRAY_AGG(events.id)
FROM intervals
JOIN events
