    SELECT
      ...
      CASE 			WHEN ts.taxon_concept_class_name IN ('Mammalia') THEN 'Mammiferes'
			WHEN ts.taxon_concept_class_name IN ('Aves') THEN 'Oiseaux'
			WHEN ts.taxon_concept_class_name IN ('Reptilia') THEN 'Reptiles'
			WHEN ts.taxon_concept_class_name IN ('Amphibia') THEN 'Amphibiens'
			WHEN ts.taxon_concept_class_name IN ('Elasmobranchii','Actinopteri','Coelacanthi','Dipneusti','Actinopterygii') THEN 'Poisson'
			WHEN ts.taxon_concept_class_name IN ('Holothuroidea','Arachnida','Insecta','Hirudinoidea','Bivalvia','Gastropoda','Cephalopoda') THEN 'Invertebres autres que les coraux'
