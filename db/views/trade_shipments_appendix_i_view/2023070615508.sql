    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'AT')))
				...
				(ts.year > 1991 AND ts.year < 2023 AND ts.taxon_concept_id = 1929 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'NA')
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'CA')))
				...
				(ts.year > 2000 AND ts.year < 2023 AND ts.taxon_concept_id = 3052 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'IS')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'IS')))

				OR

				(ts.year > 1989 AND ts.year < 2023 AND ts.taxon_concept_id = 3052 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'VC')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'VC')))

				OR

				(ts.year > 2004 AND ts.year < 2023 AND ts.taxon_concept_id = 3198 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'PW')
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'AT')))
				...
				(ts.year > 2004 AND ts.year < 2023 AND ts.taxon_concept_id = 3370 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'PW')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'PW')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'AT')))
				...
				(ts.year > 2004 AND ts.year < 2023 AND ts.taxon_concept_id = 3515 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'PW')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'PW')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'CA')))
				...
				(ts.year > 2004 AND ts.year < 2023 AND ts.taxon_concept_id = 3627 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'PW')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'PW')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'LI')))
				...
				(ts.year > 2003 AND ts.year < 2023 AND ts.taxon_concept_id = 3721 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'PH')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'PH')))

				OR

				(ts.year > 1996 AND ts.year < 2023 AND ts.taxon_concept_id = 3792 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'SA')
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'AT')))
				...
				(ts.year > 1996 AND ts.year < 2023 AND ts.taxon_concept_id = 3922 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'SA')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'SA')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'CA')))
				...
				(ts.year > 2000 AND ts.year < 2023 AND ts.taxon_concept_id = 3975 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'IS')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'IS')))

				OR

				(ts.year > 1981 AND ts.year < 2023 AND ts.taxon_concept_id = 3975 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'JP')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'JP')))

				OR

				(ts.year > 1981 AND ts.year < 2023 AND ts.taxon_concept_id = 3975 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'NO')
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'ZA')))
				...
				(ts.year > 1981 AND ts.year < 2023 AND ts.taxon_concept_id = 4062 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'SR')
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'CA')))
				...
				(ts.year > 1983 AND ts.year < 2023 AND ts.taxon_concept_id = 4329 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'JP')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'JP')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'CH')))
				...
				(ts.year > 2000 AND ts.year < 2023 AND ts.taxon_concept_id = 4442 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'MK')
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'AT')))
				...
				(ts.year > 1996 AND ts.year < 2023 AND ts.taxon_concept_id = 4494 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'SA')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'SA')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'LI')))
				...
				(ts.year > 1985 AND ts.year < 2023 AND ts.taxon_concept_id = 4650 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'SR')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'SR')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'AT')))
				...
				(ts.year > 2000 AND ts.year < 2023 AND ts.taxon_concept_id = 4979 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'IS')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'IS')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'CA')))
				...
				(ts.year > 2004 AND ts.year < 2023 AND ts.taxon_concept_id = 5781 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'PW')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'PW')))

				OR

				(ts.year > 2003 AND ts.year < 2023 AND ts.taxon_concept_id = 5863 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'PH')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'PH')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'GB')))
				...
				(ts.year > 2004 AND ts.year < 2023 AND ts.taxon_concept_id = 6244 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'PW')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'PW')))

				OR

				(ts.year > 1996 AND ts.year < 2023 AND ts.taxon_concept_id = 6244 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'SA')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'SA')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'BR')))
				...
				(ts.year > 1983 AND ts.year < 2023 AND ts.taxon_concept_id = 6352 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'JP')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'JP')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'CA')))
				...
				(ts.year > 2000 AND ts.year < 2023 AND ts.taxon_concept_id = 6477 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'IS')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'IS')))

				OR

				(ts.year > 2000 AND ts.year < 2023 AND ts.taxon_concept_id = 6477 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'JP')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'JP')))

				OR

				(ts.year > 1986 AND ts.year < 2023 AND ts.taxon_concept_id = 6477 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'NO')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'NO')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'GB')))
				...
				(ts.year > 1996 AND ts.year < 2023 AND ts.taxon_concept_id = 6741 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'SA')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'SA')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'CA')))
				...
				(ts.year > 1990 AND ts.year < 2023 AND ts.taxon_concept_id = 7257 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'CU')
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'JP')))
				...
				(ts.year > 2004 AND ts.year < 2023 AND ts.taxon_concept_id = 7257 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'PW')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'PW')))

				OR

				(ts.year > 1989 AND ts.year < 2023 AND ts.taxon_concept_id = 7257 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'VC')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'VC')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'CH')))
				...
				(ts.year > 2004 AND ts.year < 2023 AND ts.taxon_concept_id = 7286 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'PW')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'PW')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'AT')))
				...
				(ts.year > 1996 AND ts.year < 2023 AND ts.taxon_concept_id = 7466 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'SA')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'SA')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'AT')))
				...
				(ts.year > 1996 AND ts.year < 2023 AND ts.taxon_concept_id = 7821 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'SA')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'SA')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'CA')))
				...
				(ts.year > 2004 AND ts.year < 2023 AND ts.taxon_concept_id = 7938 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'PW')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'PW')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'BR')))
				...
				(ts.year > 2000 AND ts.year < 2023 AND ts.taxon_concept_id = 8288 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'IS')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'IS')))

				OR

				(ts.year > 1986 AND ts.year < 2023 AND ts.taxon_concept_id = 8288 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'JP')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'JP')))

				OR

				(ts.year > 1986 AND ts.year < 2023 AND ts.taxon_concept_id = 8288 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'NO')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'NO')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'PE')))
				...
				(ts.year > 2004 AND ts.year < 2023 AND ts.taxon_concept_id = 8288 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'PW')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'PW')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'RU')))
				...
				(ts.year > 2004 AND ts.year < 2023 AND ts.taxon_concept_id = 8325 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'PW')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'PW')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'JP')))
				...
				(ts.year > 2004 AND ts.year < 2023 AND ts.taxon_concept_id = 8560 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'PW')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'PW')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'AT')))
				...
				(ts.year > 1996 AND ts.year < 2023 AND ts.taxon_concept_id = 8607 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'SA')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'SA')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'GB')))
				...
				(ts.year > 1991 AND ts.year < 2023 AND ts.taxon_concept_id = 8935 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'NA')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'NA')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'AT')))
				...
				(ts.year > 1983 AND ts.year < 2023 AND ts.taxon_concept_id = 9048 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'JP')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'JP')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'CH')))
				...
				(ts.year > 2005 AND ts.year < 2023 AND ts.taxon_concept_id = 9382 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'JP')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'JP')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'JP')))
				...
				(ts.year > 1996 AND ts.year < 2023 AND ts.taxon_concept_id = 9441 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'SA')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'SA')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'CA')))
				...
				(ts.year > 2000 AND ts.year < 2023 AND ts.taxon_concept_id = 9445 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'IS')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'IS')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'JP')))
				...
				(ts.year > 1981 AND ts.year < 2023 AND ts.taxon_concept_id = 9445 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'JP')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'JP')))

				OR

				(ts.year > 1981 AND ts.year < 2023 AND ts.taxon_concept_id = 9445 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'NO')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'NO')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'CA')))
				...
				(ts.year > 2017 AND ts.year < 2023 AND ts.taxon_concept_id = 9644 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'AE')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'AE')))

				OR

				(ts.year > 2017 AND ts.year < 2023 AND ts.taxon_concept_id = 9644 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'CD')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'CD')))

				OR

				(ts.year > 2017 AND ts.year < 2023 AND ts.taxon_concept_id = 9644 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'SA')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'SA')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'GB')))
				...
				(ts.year > 1996 AND ts.year < 2023 AND ts.taxon_concept_id = 9871 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'SA')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'SA')))

				OR

				(ts.year > 1996 AND ts.year < 2023 AND ts.taxon_concept_id = 9919 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'SA')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'SA')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'AT')))
				...
				(ts.year > 1996 AND ts.year < 2023 AND ts.taxon_concept_id = 10054 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'SA')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'SA')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'GB')))
				...
				(ts.year > 1996 AND ts.year < 2023 AND ts.taxon_concept_id = 10464 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'SA')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'SA')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'ZW')))
				...
				(ts.year > 2000 AND ts.year < 2023 AND ts.taxon_concept_id = 10761 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'IS')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'IS')))

				OR

				(ts.year > 1981 AND ts.year < 2023 AND ts.taxon_concept_id = 10761 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'JP')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'JP')))

				OR

				(ts.year > 1981 AND ts.year < 2023 AND ts.taxon_concept_id = 10761 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'NO')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'NO')))

				OR

				(ts.year > 2004 AND ts.year < 2023 AND ts.taxon_concept_id = 10761 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'PW')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'PW')))

				OR

				(ts.year > 1996 AND ts.year < 2023 AND ts.taxon_concept_id = 10804 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'SA')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'SA')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'CA')))
				...
				(ts.year > 2000 AND ts.year < 2023 AND ts.taxon_concept_id = 10905 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'IS')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'IS')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'GB')))
				...
				(ts.year > 2005 AND ts.year < 2023 AND ts.taxon_concept_id = 11005 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'JP')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'JP')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'LI')))
				...
				(ts.year > 2003 AND ts.year < 2023 AND ts.taxon_concept_id = 11033 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'PH')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'PH')))

				OR

				(ts.year > 1990 AND ts.year < 2023 AND ts.taxon_concept_id = 11071 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'CU')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'CU')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'JP')))
				...
				(ts.year > 2004 AND ts.year < 2023 AND ts.taxon_concept_id = 11071 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'PW')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'PW')))

				OR

				(ts.year > 1981 AND ts.year < 2023 AND ts.taxon_concept_id = 11071 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'SR')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'SR')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'FR')))
				...
				(ts.year > 1980 AND ts.year < 2023 AND ts.taxon_concept_id = 12165 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'JP')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'JP')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'CH')))
				...
				(ts.year > 2000 AND ts.year < 2023 AND ts.taxon_concept_id = 12168 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'MK')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'MK')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'GB')))
				...
				(ts.year > 1996 AND ts.year < 2023 AND ts.taxon_concept_id = 12193 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'SA')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'SA')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'CH')))
				...
				(ts.year > 2000 AND ts.year < 2023 AND ts.taxon_concept_id = 12199 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'MK')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'MK')))

				OR

				(ts.year > 1996 AND ts.year < 2023 AND ts.taxon_concept_id = 12205 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'SA')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'SA')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'CH')))
				...
				(ts.year > 1996 AND ts.year < 2023 AND ts.taxon_concept_id = 12220 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'SA')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'SA')))

				OR

				(ts.year > 1996 AND ts.year < 2023 AND ts.taxon_concept_id = 12238 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'SA')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'SA')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'GB')))
				...
				(ts.year > 1980 AND ts.year < 2023 AND ts.taxon_concept_id = 12248 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'JP')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'JP')))

				OR

				(ts.year > 2004 AND ts.year < 2023 AND ts.taxon_concept_id = 12249 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'PW')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'PW')))

				OR

				(ts.year > 1996 AND ts.year < 2023 AND ts.taxon_concept_id = 12249 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'SA')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'SA')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'GB')))
				...
				(ts.year > 2004 AND ts.year < 2023 AND ts.taxon_concept_id = 12254 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'PW')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'PW')))

				OR

				(ts.year > 1996 AND ts.year < 2023 AND ts.taxon_concept_id = 12254 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'SA')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'SA')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'CH')))
				...
				(ts.year > 2004 AND ts.year < 2023 AND ts.taxon_concept_id = 12278 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'PW')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'PW')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'CH')))
				...
				(ts.year > 2000 AND ts.year < 2023 AND ts.taxon_concept_id = 12299 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'MK')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'MK')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'CH')))
				...
				(ts.year > 2000 AND ts.year < 2023 AND ts.taxon_concept_id = 12320 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'MK')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'MK')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'CA')))
				...
				(ts.year > 2004 AND ts.year < 2023 AND ts.taxon_concept_id = 12332 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'PW')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'PW')))

				OR

				(ts.year > 1996 AND ts.year < 2023 AND ts.taxon_concept_id = 12332 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'SA')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'SA')))
    ...
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'CH')))
				...
				(ts.year > 2023 AND ts.year < 2023 AND ts.taxon_concept_id = 4614 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'CA')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'CA')))

				OR

				(ts.year > 2023 AND ts.year < 2023 AND ts.taxon_concept_id = 11078 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'CA')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'CA')))

				OR

				(ts.year > 2023 AND ts.year < 2023 AND ts.taxon_concept_id = 10210 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'CA')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'CA')))

				OR

				(ts.year > 2023 AND ts.year < 2023 AND ts.taxon_concept_id = 9277 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'CA')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'CA')))

				OR

				(ts.year > 2023 AND ts.year < 2023 AND ts.taxon_concept_id = 100209 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'CA')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'CA')))

				OR

				(ts.year > 2023 AND ts.year < 2023 AND ts.taxon_concept_id = 100473 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'CA')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'CA')))

				OR

				(ts.year > 2023 AND ts.year < 2023 AND ts.taxon_concept_id = 100472 AND ((ts.reported_by_exporter IS TRUE AND exporters.iso_code2 = 'CA')
    OR (ts.reported_by_exporter IS FALSE AND importers.iso_code2 = 'CA')))
