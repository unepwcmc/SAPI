    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 1997 AND ts.year <= 2021 AND ts.taxon_concept_id = 3780 AND exporter.iso_code2 = 'PK' AND TRUE AND term.code IN ('TRO') AND TRUE AND purpose.code IN ('H','P') AND ts.country_of_origin_id IS NULL
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 1997 AND ts.year <= 2021 AND ts.taxon_concept_id = 8619 AND exporter.iso_code2 = 'ET' AND TRUE AND term.code IN ('SKI','TRO') AND TRUE AND purpose.code IN ('H','P') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 1997 AND ts.year <= 2021 AND ts.taxon_concept_id = 8619 AND exporter.iso_code2 = 'NA' AND TRUE AND term.code IN ('SKI','TRO') AND TRUE AND purpose.code IN ('H','P') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 1997 AND ts.year <= 2021 AND ts.taxon_concept_id = 8619 AND exporter.iso_code2 = 'TZ' AND TRUE AND term.code IN ('SKI','TRO') AND TRUE AND purpose.code IN ('H','P') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 500
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 1997 AND ts.year <= 2021 AND ts.taxon_concept_id = 8619 AND exporter.iso_code2 = 'ZM' AND TRUE AND term.code IN ('SKI','TRO') AND TRUE AND purpose.code IN ('H','P') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 1997 AND ts.year <= 2021 AND ts.taxon_concept_id = 8619 AND exporter.iso_code2 = 'ZW' AND TRUE AND term.code IN ('SKI','TRO') AND TRUE AND purpose.code IN ('H','P') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 500
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 1997 AND ts.year <= 2021 AND ts.taxon_concept_id = 8619 AND exporter.iso_code2 = 'BW' AND TRUE AND term.code IN ('SKI','TRO') AND TRUE AND purpose.code IN ('H','P') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 1997 AND ts.year <= 2021 AND ts.taxon_concept_id = 8619 AND exporter.iso_code2 = 'CF' AND TRUE AND term.code IN ('SKI','TRO') AND TRUE AND purpose.code IN ('H','P') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 1997 AND ts.year <= 2021 AND ts.taxon_concept_id = 8619 AND exporter.iso_code2 = 'KE' AND TRUE AND term.code IN ('SKI','TRO') AND TRUE AND purpose.code IN ('H','P') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 1997 AND ts.year <= 2021 AND ts.taxon_concept_id = 8619 AND exporter.iso_code2 = 'MW' AND TRUE AND term.code IN ('SKI','TRO') AND TRUE AND purpose.code IN ('H','P') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 1997 AND ts.year <= 2021 AND ts.taxon_concept_id = 8619 AND exporter.iso_code2 = 'MZ' AND TRUE AND term.code IN ('SKI','TRO') AND TRUE AND purpose.code IN ('H','P') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 1997 AND ts.year <= 2021 AND ts.taxon_concept_id = 8619 AND exporter.iso_code2 = 'ZA' AND TRUE AND term.code IN ('SKI','TRO') AND TRUE AND purpose.code IN ('H','P') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 1997 AND ts.year <= 2021 AND ts.taxon_concept_id = 8619 AND exporter.iso_code2 = 'UG' AND TRUE AND term.code IN ('SKI','TRO') AND TRUE AND purpose.code IN ('H','P') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
...
Res. Conf. 13.5(Rev.CoP14): "AGREES that hunting trophies of the black rhinoceros are defined as the horns or any other durable part of the body, mounted or loose and that all parts to be exported should be individually marked with reference to the country of origin, species, quota number and year of export;"' AS notes
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 2004 AND ts.year <= 2021 AND ts.taxon_concept_id = 6656 AND exporter.iso_code2 = 'NA' AND TRUE AND term.code IN ('TRO','SKI','SKU','HOR','BOD','FOO','GEN') AND TRUE AND purpose.code IN ('H','P') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 1975 AND ts.year <= 2021 AND ts.taxon_concept_id = 8935 AND exporter.iso_code2 = 'BW' AND TRUE AND term.code IN ('LIV','TRO') AND TRUE AND TRUE AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 5
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 1975 AND ts.year <= 2021 AND ts.taxon_concept_id = 8935 AND exporter.iso_code2 = 'NA' AND TRUE AND term.code IN ('SKI','LIV','TRO') AND TRUE AND TRUE AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 150
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 1975 AND ts.year <= 2021 AND ts.taxon_concept_id = 8935 AND exporter.iso_code2 = 'ZW' AND TRUE AND term.code IN ('LIV','TRO') AND TRUE AND TRUE AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 50
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 2017 AND ts.year <= 2021 AND ts.taxon_concept_id = 6353 AND TRUE AND TRUE AND term.code IN ('BON','BOP','BPR','CLA','SKE','SKU','TEE') AND source.code IN ('W') AND purpose.code IN ('T') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 2003 AND ts.year <= 2021 AND ts.taxon_concept_id = 7086 AND exporter.iso_code2 = 'BG' AND TRUE AND term.code IN ('LIV') AND source.code IN ('W') AND purpose.code IN ('T') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 0
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 2003 AND ts.year <= 2021 AND ts.taxon_concept_id = 7086 AND exporter.iso_code2 = 'GE' AND TRUE AND term.code IN ('LIV') AND source.code IN ('W') AND purpose.code IN ('T') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 0
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 2003 AND ts.year <= 2021 AND ts.taxon_concept_id = 7086 AND exporter.iso_code2 = 'RO' AND TRUE AND term.code IN ('LIV') AND source.code IN ('W') AND purpose.code IN ('T') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 0
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 2003 AND ts.year <= 2021 AND ts.taxon_concept_id = 7086 AND exporter.iso_code2 = 'RU' AND TRUE AND term.code IN ('LIV') AND source.code IN ('W') AND purpose.code IN ('T') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 0
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 2003 AND ts.year <= 2021 AND ts.taxon_concept_id = 7086 AND exporter.iso_code2 = 'TR' AND TRUE AND term.code IN ('LIV') AND source.code IN ('W') AND purpose.code IN ('T') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 0
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 2003 AND ts.year <= 2021 AND ts.taxon_concept_id = 7086 AND exporter.iso_code2 = 'UA' AND TRUE AND term.code IN ('LIV') AND source.code IN ('W') AND purpose.code IN ('T') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 0
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 1997 AND ts.year <= 2021 AND ts.taxon_concept_id = 5522 AND TRUE AND TRUE AND TRUE AND TRUE AND TRUE AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 0
...
**II** Population of Brazil and the population of Ecuador, which is included in Appendix II and is subject to a zero annual export quota until an annual export quota has been approved by the CITES Secretariat and the IUCN/SSC Crocodile Specialist Group.' AS notes
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 1995 AND ts.year <= 2021 AND ts.taxon_concept_id = 10978 AND exporter.iso_code2 = 'EC' AND TRUE AND TRUE AND TRUE AND TRUE AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 0
...
**II** Only the population of Belize, which is included in Appendix II with a zero quota for wild specimens traded for commercial purposes, and the population of Mexico.' AS notes
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 2010 AND ts.year <= 2021 AND ts.taxon_concept_id = 7747 AND exporter.iso_code2 = 'BZ' AND TRUE AND TRUE AND source.code IN ('W') AND purpose.code IN ('T') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 0
...
**II** Populations of Botswana, Egypt (subject to a zero quota for wild specimens traded for commercial purposes), Ethiopia, Kenya, Madagascar, Malawi, Mozambique, Namibia, South Africa, Uganda, the United Republic of Tanzania (subject to an annual export quota of no more than 1,600 wild specimens including hunting trophies, in addition to ranched specimens), Zambia and Zimbabwe. ' AS notes
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 2010 AND ts.year <= 2021 AND ts.taxon_concept_id = 10745 AND exporter.iso_code2 = 'EG' AND TRUE AND TRUE AND source.code IN ('W') AND purpose.code IN ('T') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 0
...
**II** Populations of Botswana, Egypt (subject to a zero quota for wild specimens traded for commercial purposes), Ethiopia, Kenya, Madagascar, Malawi, Mozambique, Namibia, South Africa, Uganda, the United Republic of Tanzania (subject to an annual export quota of no more than 1,600 wild specimens including hunting trophies, in addition to ranched specimens), Zambia and Zimbabwe. ' AS notes
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 2010 AND ts.year <= 2021 AND ts.taxon_concept_id = 10745 AND exporter.iso_code2 = 'TZ' AND TRUE AND TRUE AND source.code IN ('W') AND TRUE AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
...
**II** Only the populations of Australia, Indonesia, Malaysia [wild harvest restricted to the State of Sarawak and a zero quota for wild specimens for the other States of Malaysia (Sabah and Peninsular Malaysia), with no change in the zero quota unless approved by the Parties] and Papua New Guinea; all other populations are included in Appendix I.' AS notes
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 2017 AND ts.year <= 2021 AND ts.taxon_concept_id = 8560 AND exporter.iso_code2 = 'MY' AND TRUE AND TRUE AND source.code IN ('W') AND TRUE AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 0
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 2017 AND ts.year <= 2021 AND ts.taxon_concept_id = 68179 AND TRUE AND TRUE AND TRUE AND source.code IN ('W') AND TRUE AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 0
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 2017 AND ts.year <= 2021 AND ts.taxon_concept_id = 68245 AND TRUE AND TRUE AND TRUE AND source.code IN ('W') AND TRUE AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 0
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 2017 AND ts.year <= 2021 AND ts.taxon_concept_id = 68148 AND TRUE AND TRUE AND TRUE AND source.code IN ('W') AND TRUE AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 0
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 2017 AND ts.year <= 2021 AND ts.taxon_concept_id = 68213 AND TRUE AND TRUE AND TRUE AND source.code IN ('W') AND TRUE AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 0
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 2017 AND ts.year <= 2021 AND ts.taxon_concept_id = 68195 AND TRUE AND TRUE AND TRUE AND source.code IN ('W') AND TRUE AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 0
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 2017 AND ts.year <= 2021 AND ts.taxon_concept_id = 67618 AND TRUE AND TRUE AND TRUE AND source.code IN ('W') AND purpose.code IN ('T') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 0
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 2013 AND ts.year <= 2021 AND ts.taxon_concept_id = 7441 AND TRUE AND TRUE AND TRUE AND source.code IN ('W') AND TRUE AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 0
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 2013 AND ts.year <= 2021 AND ts.taxon_concept_id = 4927 AND TRUE AND TRUE AND TRUE AND source.code IN ('W') AND purpose.code IN ('T') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 0
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 2013 AND ts.year <= 2021 AND ts.taxon_concept_id = 4397 AND TRUE AND TRUE AND TRUE AND source.code IN ('W') AND purpose.code IN ('T') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 0
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 2013 AND ts.year <= 2021 AND ts.taxon_concept_id = 8231 AND TRUE AND TRUE AND TRUE AND source.code IN ('W') AND purpose.code IN ('T') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 0
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 2013 AND ts.year <= 2021 AND ts.taxon_concept_id = 7271 AND TRUE AND TRUE AND TRUE AND source.code IN ('W') AND purpose.code IN ('T') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 0
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 2013 AND ts.year <= 2021 AND ts.taxon_concept_id = 10210 AND TRUE AND TRUE AND TRUE AND source.code IN ('W') AND purpose.code IN ('T') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 0
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 2013 AND ts.year <= 2021 AND ts.taxon_concept_id = 3678 AND TRUE AND TRUE AND TRUE AND source.code IN ('W') AND purpose.code IN ('T') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 0
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 2013 AND ts.year <= 2021 AND ts.taxon_concept_id = 10699 AND TRUE AND TRUE AND TRUE AND source.code IN ('W') AND purpose.code IN ('T') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 0
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 2013 AND ts.year <= 2021 AND ts.taxon_concept_id = 6783 AND TRUE AND TRUE AND TRUE AND source.code IN ('W') AND purpose.code IN ('T') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 0
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 2013 AND ts.year <= 2021 AND ts.taxon_concept_id = 6023 AND TRUE AND TRUE AND TRUE AND source.code IN ('W') AND purpose.code IN ('T') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 0
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 2013 AND ts.year <= 2021 AND ts.taxon_concept_id = 5712 AND TRUE AND TRUE AND TRUE AND source.code IN ('W') AND purpose.code IN ('T') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 0
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 2013 AND ts.year <= 2021 AND ts.taxon_concept_id = 5930 AND TRUE AND TRUE AND TRUE AND source.code IN ('W') AND purpose.code IN ('T') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 0
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 2013 AND ts.year <= 2021 AND ts.taxon_concept_id = 7457 AND TRUE AND TRUE AND TRUE AND source.code IN ('W') AND purpose.code IN ('T') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 0
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 2013 AND ts.year <= 2021 AND ts.taxon_concept_id = 4484 AND TRUE AND TRUE AND TRUE AND source.code IN ('W') AND purpose.code IN ('T') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 0
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 2013 AND ts.year <= 2021 AND ts.taxon_concept_id = 3413 AND TRUE AND TRUE AND TRUE AND source.code IN ('W') AND purpose.code IN ('T') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 0
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 2000 AND ts.year <= 2021 AND ts.taxon_concept_id = 31025 AND TRUE AND TRUE AND TRUE AND source.code IN ('W') AND purpose.code IN ('T') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 0
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 2019 AND ts.year <= 2021 AND ts.taxon_concept_id = 9751 AND TRUE AND TRUE AND TRUE AND source.code IN ('W') AND purpose.code IN ('T') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 0
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 2019 AND ts.year <= 2021 AND ts.taxon_concept_id = 12241 AND TRUE AND TRUE AND TRUE AND source.code IN ('W') AND purpose.code IN ('T') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 0
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 2019 AND ts.year <= 2021 AND ts.taxon_concept_id = 8765 AND TRUE AND TRUE AND TRUE AND source.code IN ('W') AND purpose.code IN ('T') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 0
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 2019 AND ts.year <= 2021 AND ts.taxon_concept_id = 6436 AND TRUE AND TRUE AND TRUE AND source.code IN ('W') AND purpose.code IN ('T') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 0
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 2019 AND ts.year <= 2021 AND ts.taxon_concept_id = 98192 AND TRUE AND TRUE AND TRUE AND source.code IN ('W') AND purpose.code IN ('T') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 0
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 2019 AND ts.year <= 2021 AND ts.taxon_concept_id = 98195 AND TRUE AND TRUE AND TRUE AND source.code IN ('W') AND purpose.code IN ('T') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 0
    ...
    (
      ...
      WHERE ts.id IN (
        ...
        FROM (
          ...
          WHERE ts.year >= 2019 AND ts.year <= 2021 AND ts.taxon_concept_id = 98201 AND TRUE AND TRUE AND TRUE AND source.code IN ('W') AND purpose.code IN ('T') AND ts.country_of_origin_id IS NULL
          AND (source.name_en != 'Confiscations/seizures' OR ts.source_id IS NULL)
          GROUP BY year, reported_by_exporter
          HAVING SUM(quantity) > 0
