...
CREATE VIEW year_annual_reports_by_countries AS
 SELECT row_number() OVER (ORDER BY b.name_en, b.year DESC) AS no, b.name_en, 
    b.year, 
        CASE
    ...
    b.year_created
   FROM ( SELECT a.name_en, a.year, sum(a.type) AS sum, a.year_created
           FROM (         SELECT DISTINCT g.name_en, t.year, 1 AS type, 
