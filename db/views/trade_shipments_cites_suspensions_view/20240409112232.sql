      ...
      WHERE s.id NOT IN (
        ...
        WHERE 
				...
				(ts.year >= 2015 AND ts.year <= 2016 AND TRUE AND exporters.iso_code2 = 'EQ' AND TRUE AND terms.code IN ('LIV') AND TRUE AND TRUE AND ts.country_of_origin_id IS NULL)
