      ...
      WHERE s.id NOT IN (
        ...
        LEFT OUTER JOIN trade_codes terms ON terms.id = ts.term_id
        WHERE 
				(ts.year >= 2005 AND ts.year <= 2024 AND TRUE AND exporters.iso_code2 = 'AF' AND TRUE AND TRUE AND TRUE AND purposes.code IN ('Z','G','Q','S','H','P','M','E','N','B','L') AND ts.country_of_origin_id IS NULL)
				...
				(ts.year >= 2006 AND ts.year <= 2024 AND ts.taxon_concept_id = 55214 AND exporters.iso_code2 = 'AR' AND TRUE AND TRUE AND sources.code IN ('R') AND TRUE AND ts.country_of_origin_id IS NULL)

				OR

				(ts.year >= 2006 AND ts.year <= 2024 AND ts.taxon_concept_id = 5390 AND exporters.iso_code2 = 'AR' AND TRUE AND TRUE AND sources.code IN ('R') AND TRUE AND ts.country_of_origin_id IS NULL)

				OR

				(ts.year >= 2006 AND ts.year <= 2024 AND ts.taxon_concept_id = 8246 AND exporters.iso_code2 = 'AR' AND TRUE AND terms.code IN ('TRO') AND TRUE AND TRUE AND ts.country_of_origin_id IS NULL)

				OR

				(ts.year >= 2006 AND ts.year <= 2024 AND ts.taxon_concept_id = 6330 AND exporters.iso_code2 = 'AR' AND TRUE AND terms.code IN ('TRO') AND TRUE AND TRUE AND ts.country_of_origin_id IS NULL)
				...
				(ts.year >= 2018 AND ts.year <= 2022 AND ts.taxon_concept_id = 9644 AND exporters.iso_code2 = 'CD' AND TRUE AND TRUE AND sources.code IN ('A','C','D','F','I','O','R','U','X') AND TRUE AND ts.country_of_origin_id IS NULL)

				OR

				(ts.year >= 2011 AND ts.year <= 2024 AND TRUE AND exporters.iso_code2 = 'DJ' AND TRUE AND TRUE AND TRUE AND purposes.code IN ('Z','G','Q','S','H','P','M','E','N','B','L') AND ts.country_of_origin_id IS NULL)

				OR

				(ts.year >= 2016 AND ts.year <= 2018 AND ts.taxon_concept_id = 9644 AND exporters.iso_code2 = 'CD' AND TRUE AND TRUE AND TRUE AND purposes.code IN ('Z','G','Q','S','H','P','M','E','N','B','L') AND ts.country_of_origin_id IS NULL)

				OR

				(ts.year >= 2019 AND ts.year <= 2021 AND TRUE AND exporters.iso_code2 = 'GN' AND TRUE AND TRUE AND TRUE AND purposes.code IN ('Z','G','Q','S','H','P','M','E','N','B','L') AND ts.country_of_origin_id IS NULL)

				OR

				(ts.year >= 1999 AND ts.year <= 2024 AND TRUE AND exporters.iso_code2 = 'IN' AND TRUE AND TRUE AND sources.code IN ('A','C','D','F','I','O','R','U','X') AND purposes.code IN ('Z','G','Q','S','H','P','M','E','N','B','L') AND ts.country_of_origin_id IS NULL)

				OR

				(ts.year >= 2018 AND ts.year <= 2024 AND TRUE AND exporters.iso_code2 = 'IN' AND TRUE AND TRUE AND sources.code IN ('A','C','D','F','I','O','R','U','X') AND purposes.code IN ('Z','G','Q','S','H','P','M','E','N','B','L') AND ts.country_of_origin_id IS NULL)
				...
				(ts.year >= 2018 AND ts.year <= 2022 AND ts.taxon_concept_id = 12737 AND exporters.iso_code2 = 'LA' AND TRUE AND TRUE AND TRUE AND purposes.code IN ('Z','G','Q','S','H','P','M','E','N','B','L') AND ts.country_of_origin_id IS NULL)
				...
				(ts.year >= 2018 AND ts.year <= 2024 AND TRUE AND exporters.iso_code2 = 'LR' AND TRUE AND TRUE AND TRUE AND purposes.code IN ('Z','G','Q','S','H','P','M','E','N','B','L') AND ts.country_of_origin_id IS NULL)
				...
				(ts.year >= 2022 AND ts.year <= 2024 AND TRUE AND exporters.iso_code2 = 'GN' AND TRUE AND TRUE AND TRUE AND purposes.code IN ('Z','G','Q','S','H','P','M','E','N','B','L') AND ts.country_of_origin_id IS NULL)

				OR

				(ts.year >= 2021 AND ts.year <= 2022 AND TRUE AND exporters.iso_code2 = 'GN' AND TRUE AND TRUE AND TRUE AND purposes.code IN ('Z','G','Q','S','H','P','M','E','N','B','L') AND ts.country_of_origin_id IS NULL)

				OR

				(ts.year >= 2022 AND ts.year <= 2024 AND ts.taxon_concept_id = 12881 AND exporters.iso_code2 = 'MG' AND TRUE AND TRUE AND TRUE AND purposes.code IN ('Z','G','Q','S','H','P','M','E','N','B','L') AND ts.country_of_origin_id IS NULL)

				OR

				(ts.year >= 2018 AND ts.year <= 2022 AND ts.taxon_concept_id = 12881 AND exporters.iso_code2 = 'MG' AND TRUE AND TRUE AND TRUE AND purposes.code IN ('Z','G','Q','S','H','P','M','E','N','B','L') AND ts.country_of_origin_id IS NULL)
				...
				(ts.year >= 2004 AND ts.year <= 2019 AND TRUE AND exporters.iso_code2 = 'MR' AND TRUE AND TRUE AND TRUE AND purposes.code IN ('Z','G','Q','S','H','P','M','E','N','B','L') AND ts.country_of_origin_id IS NULL)
				...
				(ts.year >= 2018 AND ts.year <= 2024 AND ts.taxon_concept_id = 67733 AND exporters.iso_code2 = 'NG' AND TRUE AND TRUE AND TRUE AND purposes.code IN ('Z','G','Q','S','H','P','M','E','N','B','L') AND ts.country_of_origin_id IS NULL)
				...
				(ts.year >= 2022 AND ts.year <= 2024 AND ts.taxon_concept_id = 5690 AND exporters.iso_code2 = 'LA' AND TRUE AND terms.code IN ('BAL','BAR','BOD','BON','CAL','CAP','CAR','BOC','HOC','IVC','CAV','CHP','CLA','CLO','COR','COS','CUL','DER','DPL','EAR','EGG','EGL','ESH','EXT','FEA','FIB','DFN','FFN','FIG','FLO','FPT','LEG','FRU','FOO','FPL','FPS','GAL','GAB','GAR','GEN','GIL','GRS','HAI','HAP','HOR','JWL','IJW','KNL','LPL','LPS','LVS','LOG','MEA','MED','MUS','OIL','PRL','KEY','BOP','HOP','IVP','PLA','PLY','POW','PUP','ROO','RUG','ROS','SAW','SCA','SEE','SHE','SID','SKE','SKI','SKP','SKU','SOU','SPE','STE','SWI','TAI','TEE','TIM','TRW','TRO','TRU','TUS','VEN','WAX','WPR') AND TRUE AND TRUE AND ts.country_of_origin_id IS NULL)
				...
				(ts.year >= 2022 AND ts.year <= 2024 AND ts.taxon_concept_id = 12737 AND exporters.iso_code2 = 'LA' AND TRUE AND TRUE AND TRUE AND purposes.code IN ('Z','G','Q','S','H','P','M','E','N','B','L') AND ts.country_of_origin_id IS NULL)

				OR

				(ts.year >= 2022 AND ts.year <= 2024 AND ts.taxon_concept_id = 9644 AND exporters.iso_code2 = 'CD' AND TRUE AND TRUE AND TRUE AND purposes.code IN ('Z','G','Q','S','H','P','M','E','N','B','L') AND ts.country_of_origin_id IS NULL)

				OR

				(ts.year >= 2022 AND ts.year <= 2024 AND ts.taxon_concept_id = 67733 AND exporters.iso_code2 = 'CM' AND TRUE AND TRUE AND TRUE AND purposes.code IN ('Z','G','Q','S','H','P','M','E','N','B','L') AND ts.country_of_origin_id IS NULL)

				OR

				(ts.year >= 2022 AND ts.year <= 2024 AND ts.taxon_concept_id = 67733 AND exporters.iso_code2 = 'CF' AND TRUE AND TRUE AND TRUE AND purposes.code IN ('Z','G','Q','S','H','P','M','E','N','B','L') AND ts.country_of_origin_id IS NULL)

				OR

				(ts.year >= 2022 AND ts.year <= 2024 AND ts.taxon_concept_id = 67733 AND exporters.iso_code2 = 'TD' AND TRUE AND TRUE AND TRUE AND purposes.code IN ('Z','G','Q','S','H','P','M','E','N','B','L') AND ts.country_of_origin_id IS NULL)

				OR

				(ts.year >= 2022 AND ts.year <= 2024 AND ts.taxon_concept_id = 67733 AND exporters.iso_code2 = 'GM' AND TRUE AND TRUE AND TRUE AND purposes.code IN ('Z','G','Q','S','H','P','M','E','N','B','L') AND ts.country_of_origin_id IS NULL)
				...
				(ts.year >= 2022 AND ts.year <= 2024 AND ts.taxon_concept_id = 67733 AND exporters.iso_code2 = 'ML' AND TRUE AND TRUE AND TRUE AND purposes.code IN ('Z','G','Q','S','H','P','M','E','N','B','L') AND ts.country_of_origin_id IS NULL)

				OR

				(ts.year >= 2022 AND ts.year <= 2024 AND ts.taxon_concept_id = 67733 AND exporters.iso_code2 = 'TG' AND TRUE AND TRUE AND TRUE AND purposes.code IN ('Z','G','Q','S','H','P','M','E','N','B','L') AND ts.country_of_origin_id IS NULL)

				OR

				(ts.year >= 2022 AND ts.year <= 2024 AND TRUE AND exporters.iso_code2 = 'ST' AND TRUE AND TRUE AND TRUE AND purposes.code IN ('Z','G','Q','S','H','P','M','E','N','B','L') AND ts.country_of_origin_id IS NULL)

				OR

				(ts.year >= 2022 AND ts.year <= 2024 AND ts.taxon_concept_id = 67733 AND exporters.iso_code2 = 'GW' AND TRUE AND TRUE AND TRUE AND purposes.code IN ('Z','G','Q','S','H','P','M','E','N','B','L') AND ts.country_of_origin_id IS NULL)

				OR

				(ts.year >= 2016 AND ts.year <= 2018 AND TRUE AND exporters.iso_code2 = 'LA' AND TRUE AND terms.code IN ('CAR','WPR') AND TRUE AND purposes.code IN ('Z','G','Q','S','H','P','M','E','N','B','L') AND ts.country_of_origin_id IS NULL)

				OR

				(ts.year >= 2014 AND ts.year <= 2014 AND ts.taxon_concept_id = 6940 AND exporters.iso_code2 = 'MG' AND TRUE AND TRUE AND TRUE AND TRUE AND ts.country_of_origin_id IS NULL)

				OR

				(ts.year >= 2016 AND ts.year <= 2016 AND ts.taxon_concept_id = 6940 AND exporters.iso_code2 = 'MG' AND TRUE AND TRUE AND TRUE AND TRUE AND ts.country_of_origin_id IS NULL)

				OR

				(ts.year >= 2022 AND ts.year <= 2024 AND ts.taxon_concept_id = 12737 AND exporters.iso_code2 = 'MG' AND TRUE AND TRUE AND TRUE AND purposes.code IN ('Z','G','Q','S','H','P','M','E','N','B','L') AND ts.country_of_origin_id IS NULL)

				OR

				(ts.year >= 2018 AND ts.year <= 2022 AND ts.taxon_concept_id = 12737 AND exporters.iso_code2 = 'MG' AND TRUE AND TRUE AND TRUE AND purposes.code IN ('Z','G','Q','S','H','P','M','E','N','B','L') AND ts.country_of_origin_id IS NULL)

				OR

				(ts.year >= 2016 AND ts.year <= 2017 AND ts.taxon_concept_id = 12737 AND exporters.iso_code2 = 'MG' AND TRUE AND TRUE AND TRUE AND purposes.code IN ('Z','G','Q','S','H','P','M','E','N','B','L') AND ts.country_of_origin_id IS NULL)

				OR

				(ts.year >= 2017 AND ts.year <= 2018 AND ts.taxon_concept_id = 12737 AND exporters.iso_code2 = 'MG' AND TRUE AND TRUE AND TRUE AND purposes.code IN ('Z','G','Q','S','H','P','M','E','N','B','L') AND ts.country_of_origin_id IS NULL)

				OR

				(ts.year >= 2016 AND ts.year <= 2017 AND ts.taxon_concept_id = 12881 AND exporters.iso_code2 = 'MG' AND TRUE AND TRUE AND TRUE AND purposes.code IN ('Z','G','Q','S','H','P','M','E','N','B','L') AND ts.country_of_origin_id IS NULL)

				OR

				(ts.year >= 2017 AND ts.year <= 2018 AND ts.taxon_concept_id = 12881 AND exporters.iso_code2 = 'MG' AND TRUE AND TRUE AND TRUE AND purposes.code IN ('Z','G','Q','S','H','P','M','E','N','B','L') AND ts.country_of_origin_id IS NULL)

				OR

				(ts.year >= 2023 AND ts.year <= 2024 AND TRUE AND exporters.iso_code2 = 'MX' AND TRUE AND TRUE AND TRUE AND purposes.code IN ('Z','G','Q','S','H','P','M','E','N','B','L') AND ts.country_of_origin_id IS NULL)

				OR

				(ts.year >= 2004 AND ts.year <= 2019 AND TRUE AND exporters.iso_code2 = 'SO' AND TRUE AND TRUE AND TRUE AND purposes.code IN ('Z','G','Q','S','H','P','M','E','N','B','L') AND ts.country_of_origin_id IS NULL)

				OR

				(ts.year >= 2019 AND ts.year <= 2024 AND TRUE AND exporters.iso_code2 = 'SO' AND TRUE AND TRUE AND TRUE AND purposes.code IN ('Z','G','Q','S','H','P','M','E','N','B','L') AND ts.country_of_origin_id IS NULL)

				OR

				(ts.year >= 2015 AND ts.year <= 2016 AND TRUE AND exporters.iso_code2 = 'GQ' AND TRUE AND terms.code IN ('LIV') AND TRUE AND TRUE AND ts.country_of_origin_id IS NULL)
