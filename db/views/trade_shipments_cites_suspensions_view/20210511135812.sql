      ...
      WHERE s.id NOT IN (
        ...
        LEFT OUTER JOIN trade_codes terms ON terms.id = ts.term_id
        WHERE 
				(ts.year >= 1999 AND ts.year <= 2021 AND TRUE AND exporters.iso_code2 = 'IN' AND TRUE AND TRUE AND sources.code IN ('A','C','D','F','I','O','R','U','X') AND purposes.code IN ('Z','G','Q','S','H','P','M','E','N','B','L') AND ts.country_of_origin_id IS NULL)

				OR

				(ts.year >= 2004 AND ts.year <= 2021 AND TRUE AND exporters.iso_code2 = 'SO' AND TRUE AND TRUE AND TRUE AND purposes.code IN ('Z','G','Q','S','H','P','M','E','N','B','L') AND ts.country_of_origin_id IS NULL)
				...
				(ts.year >= 2005 AND ts.year <= 2021 AND TRUE AND exporters.iso_code2 = 'AF' AND TRUE AND TRUE AND TRUE AND purposes.code IN ('Z','G','Q','S','H','P','M','E','N','B','L') AND ts.country_of_origin_id IS NULL)

				OR

				(ts.year >= 2006 AND ts.year <= 2021 AND ts.taxon_concept_id = 55214 AND exporters.iso_code2 = 'AR' AND TRUE AND TRUE AND sources.code IN ('R') AND TRUE AND ts.country_of_origin_id IS NULL)

				OR

				(ts.year >= 2006 AND ts.year <= 2021 AND ts.taxon_concept_id = 5390 AND exporters.iso_code2 = 'AR' AND TRUE AND TRUE AND sources.code IN ('R') AND TRUE AND ts.country_of_origin_id IS NULL)

				OR

				(ts.year >= 2006 AND ts.year <= 2021 AND ts.taxon_concept_id = 8246 AND exporters.iso_code2 = 'AR' AND TRUE AND terms.code IN ('TRO') AND TRUE AND TRUE AND ts.country_of_origin_id IS NULL)

				OR

				(ts.year >= 2006 AND ts.year <= 2021 AND ts.taxon_concept_id = 6330 AND exporters.iso_code2 = 'AR' AND TRUE AND terms.code IN ('TRO') AND TRUE AND TRUE AND ts.country_of_origin_id IS NULL)
				...
				(ts.year >= 2011 AND ts.year <= 2021 AND TRUE AND exporters.iso_code2 = 'DJ' AND TRUE AND TRUE AND TRUE AND purposes.code IN ('Z','G','Q','S','H','P','M','E','N','B','L') AND ts.country_of_origin_id IS NULL)
				...
				(ts.year >= 2018 AND ts.year <= 2021 AND TRUE AND exporters.iso_code2 = 'LR' AND TRUE AND TRUE AND TRUE AND purposes.code IN ('Z','G','Q','S','H','P','M','E','N','B','L') AND ts.country_of_origin_id IS NULL)

				OR

				(ts.year >= 2018 AND ts.year <= 2021 AND TRUE AND exporters.iso_code2 = 'IN' AND TRUE AND TRUE AND sources.code IN ('A','C','D','F','I','O','R','U','X') AND purposes.code IN ('Z','G','Q','S','H','P','M','E','N','B','L') AND ts.country_of_origin_id IS NULL)

				OR

				(ts.year >= 2018 AND ts.year <= 2021 AND ts.taxon_concept_id = 9644 AND exporters.iso_code2 = 'CD' AND TRUE AND TRUE AND sources.code IN ('A','C','D','F','I','O','R','U','X') AND TRUE AND ts.country_of_origin_id IS NULL)

				OR

				(ts.year >= 2018 AND ts.year <= 2021 AND ts.taxon_concept_id = 12737 AND exporters.iso_code2 = 'LA' AND TRUE AND TRUE AND TRUE AND purposes.code IN ('Z','G','Q','S','H','P','M','E','N','B','L') AND ts.country_of_origin_id IS NULL)

				OR

				(ts.year >= 2018 AND ts.year <= 2021 AND ts.taxon_concept_id = 67733 AND exporters.iso_code2 = 'NG' AND TRUE AND TRUE AND TRUE AND purposes.code IN ('Z','G','Q','S','H','P','M','E','N','B','L') AND ts.country_of_origin_id IS NULL)
