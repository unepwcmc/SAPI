...
BEGIN
    ...
    -- still need to set the old quotas as not current

    GET DIAGNOSTICS updated_rows = ROW_COUNT;
    RAISE INFO '[%] Inserted % quotas', 'trade_transactions', updated_rows;
    ...
    GET DIAGNOSTICS updated_rows = ROW_COUNT;
    RAISE INFO '[%] Set is_current to false for % quotas', 'trade_transactions', updated_rows;
  END;
$$;
