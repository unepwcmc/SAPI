...
class UpdateConversionRulesForTradePlusFormattedDataView < ActiveRecord::Migration[4.2]
  def up
    safety_assured do
      ...
      execute "CREATE VIEW trade_plus_formatted_data_view AS #{view_sql('20240207164147', 'trade_plus_formatted_data_view')}"
      execute "CREATE VIEW trade_plus_formatted_data_final_view AS #{view_sql('20240207164147', 'trade_plus_formatted_data_final_view')}"
