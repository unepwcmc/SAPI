class RemoveFullyCoveredFromTaxonConcepts < ActiveRecord::Migration
  def up
    execute <<-SQL
    ...
    (listing->'usr_cites_excluded')::BOOLEAN AS usr_cites_excluded,
  ...
  SQL
    ...
    remove_column :taxon_concepts, :fully_covered

  end

  def down
    add_column :taxon_concepts, :fully_covered, :boolean
