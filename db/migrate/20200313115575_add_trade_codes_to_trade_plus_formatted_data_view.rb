class AddTradeCodesToTradePlusFormattedDataView < ActiveRecord::Migration
  def up
    ...
    execute "CREATE VIEW trade_plus_formatted_data_view AS #{view_sql('20200313114441', 'trade_plus_formatted_data_view')}"
