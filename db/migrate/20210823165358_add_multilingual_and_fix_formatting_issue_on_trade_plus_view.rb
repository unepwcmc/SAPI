class AddMultilingualAndFixFormattingIssueOnTradePlusView < ActiveRecord::Migration
  def up
    ...
    execute "CREATE VIEW trade_plus_formatted_data_view AS #{view_sql('20210823165358', 'trade_plus_formatted_data_view')}"
    execute "CREATE VIEW trade_plus_formatted_data_final_view AS #{view_sql('20210823165358', 'trade_plus_formatted_data_final_view')}"
