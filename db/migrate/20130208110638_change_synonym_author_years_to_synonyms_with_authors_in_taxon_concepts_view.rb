class ChangeSynonymAuthorYearsToSynonymsWithAuthorsInTaxonConceptsView < ActiveRecord::Migration
  def change
  execute <<-SQL
    ...
    ARRAY_AGG(synonym_tc.full_name || ' ' || synonym_tc.author_year) AS synonyms_with_authors_ary
    FROM taxon_concepts
