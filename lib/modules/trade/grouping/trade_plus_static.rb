class Trade::Grouping::TradePlusStatic < Trade::Grouping::Base
  ...
  def initialize(attributes, opts = {})
    ...
    raise ArgumentError, 'Bad reported_by' unless /\A\w+\z/.match?(opts[:reported_by])
    raise ArgumentError, 'Bad reported_by_party' unless /\A\w+\z/.match?(opts[:reported_by_party])
    raise ArgumentError, 'Bad locale' unless /\A\w+\z/.match?(opts[:locale])
    ...
    raise ArgumentError, 'Bad limit' unless opts[:limit].blank? || /\A\d+\z/.match?(opts[:limit])
