...
# Indexes
#
#  index_trade_restriction_terms_on_created_by_id         (created_by_id)
#  index_trade_restriction_terms_on_term_id               (term_id)
#  index_trade_restriction_terms_on_trade_restriction_id  (trade_restriction_id)
#  index_trade_restriction_terms_on_updated_by_id         (updated_by_id)
#
# Foreign Keys
#
