...
describe Admin::NomenclatureChangesHelper do
  describe 'split_blurb' do
    ...
    context 'split with outputs' do
      before { @nomenclature_change = split_with_input_and_output }
    ...
    context 'split with output new taxon' do
      before { @nomenclature_change = split_with_input_and_output_new_taxon }
  ...
  describe 'lump_blurb' do
    ...
    context 'lump with output' do
      before { @nomenclature_change = lump_with_inputs_and_output }
    ...
    context 'lump with output new taxon' do
      before { @nomenclature_change = lump_with_inputs_and_output_new_taxon }
  ...
  describe 'status_change_blurb' do
    ...
    context 'status upgrade with swap' do
      before { @nomenclature_change = a_to_s_with_swap }
