= Species+ {<img src="https://secure.travis-ci.org/unepwcmc/SAPI.png" />}[http://travis-ci.org/unepwcmc/SAPI] {<img src="https://codeclimate.com/badge.png" />}[https://codeclimate.com/github/unepwcmc/SAPI]
...
(packages as for Ubuntu)
  ...
  - Pandoc (for html => latex conversions)
     - pandoc
